...
int main(int argc, char ** argv){
	...
	energy_match.check("total energy",     result.energy.total()    , -25.538481767821);
	energy_match.check("kinetic energy",   result.energy.kinetic()  ,  13.234089393966);
	energy_match.check("eigenvalues",      result.energy.eigenvalues,   3.727349712804);
	energy_match.check("external energy",  result.energy.external   ,  -9.170795214804);
	energy_match.check("non-local energy", result.energy.nonlocal   ,   4.099633562591);
