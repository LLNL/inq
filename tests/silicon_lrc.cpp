...
int main(int argc, char ** argv){
	...
	real_time::propagate<>(ions, electrons, output, input::interaction::lda()|input::interaction::gauge_field(0.2), options::real_time{}.num_steps(30).dt(0.04_atomictime), ions::propagator::fixed{}, kick);
