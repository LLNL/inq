...
int main(int argc, char ** argv){
...

	{
		...
		auto result = ground_state::calculate(ions, electrons, input::interaction::pbe(), inq::input::scf{}.steepest_descent().energy_tolerance(1e-8_Ha));
	...
	{
		auto result = ground_state::calculate(ions, electrons, input::interaction::pbe0(), inq::input::scf{}.steepest_descent().scf_steps(0));
	...
	{
		auto result = ground_state::calculate(ions, electrons, input::interaction::hartree_fock(), inq::input::scf{}.steepest_descent().energy_tolerance(1e-8_Ha));
