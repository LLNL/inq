...
int main(int argc, char ** argv){
	...
	{
		systems::electrons electrons(env.par(), ions, box, input::config::cutoff(35.0_Ha) | input::config::extra_states(3), input::kpoints::gamma() + input::kpoints::point({-0.5, -0.5, -0.5}, 0.0));
