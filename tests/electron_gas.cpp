...
int main(int argc, char ** argv){
...

	{
		...
		systems::electrons electrons(env.par(), ions, box, input::kpoints::grid({1, 1, 3}), input::config::cutoff(30.0_Ha) | input::config::temperature(300.0_K) | input::config::extra_states(2) | input::config::excess_charge(14.0));
...

	{
		...
		systems::ions ions(box);
		systems::electrons electrons(env.par(), ions, box, input::config::cutoff(30.0_Ha) | input::config::temperature(300.0_K) | input::config::extra_states(2) | input::config::excess_charge(14.0), input::kpoints::grid({1, 1, 3}));
...

	{
		...
		systems::ions ions(box);
		systems::electrons electrons(env.par(), ions, box, input::config::cutoff(30.0_Ha) | input::config::temperature(300.0_K) | input::config::extra_states(2) | input::config::excess_charge(18.0), input::kpoints::grid({1, 1, 1}, false));
