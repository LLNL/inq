...
inq util match `inq result energy total`            -23.834202378912 3e-5
inq util match `inq result energy kinetic`           14.428062931586 3e-5
inq util match `inq result energy eigenvalues`        7.649418116188 3e-5
inq util match `inq result energy hartree`            0.000000000000 3e-5
inq util match `inq result energy external`         -12.019317709315 3e-5
inq util match `inq result energy non-local`          5.240672893917 3e-5
