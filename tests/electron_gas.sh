...
inq util match `inq energy total`           -0.567967486012 3e-5
inq util match `inq energy kinetic`          2.485678153650 3e-5
inq util match `inq energy eigenvalues`     -1.488506069666 3e-5
inq util match `inq energy hartree`          0.000000110256 3e-5
inq util match `inq energy external`         0.000000000000 3e-5
inq util match `inq energy non-local`        0.000000000000 3e-5
inq util match `inq energy xc`              -3.053645749918 3e-5
inq util match `inq energy nvxc`            -3.974184443829 3e-5
inq util match `inq energy exact-exchange`   0.000000000000 3e-5
inq util match `inq energy ion`              0.000000000000 3e-5
...
inq util match `inq energy total`           -0.567967360088 1e-5
inq util match `inq energy kinetic`          2.485678164227 1e-5
inq util match `inq energy eigenvalues`     -1.488505578638 1e-5
inq util match `inq energy hartree`          0.000000587891 1e-5
inq util match `inq energy external`         0.000000000000 1e-5
inq util match `inq energy non-local`        0.000000000000 1e-5
inq util match `inq energy xc`              -3.053646112207 1e-5
inq util match `inq energy nvxc`            -3.974184918648 1e-5
