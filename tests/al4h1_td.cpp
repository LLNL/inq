...
int main(int argc, char ** argv){
	...
	real_time::propagate<>(ions, electrons, [&](auto data){energy.push_back(data.energy().total());}, input::interaction::lda(), options::real_time::num_steps(30) | options::real_time::dt(0.055_atomictime));
