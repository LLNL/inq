...
int main(int argc, char ** argv){
	...
	
	{
		...
		match.check("ETRS kick: dipole step   0", dip[0],    0.043955366939);
		match.check("ETRS kick: dipole step  10", dip[10],   0.376346615799);
		match.check("ETRS kick: dipole step  20", dip[20],   0.525426289719);
		match.check("ETRS kick: dipole step  30", dip[30],   0.550931087362);
		match.check("ETRS kick: dipole step  40", dip[40],   0.497454551158);
		match.check("ETRS kick: dipole step  50", dip[50],   0.397016950105);
		match.check("ETRS kick: dipole step  60", dip[60],   0.273814809864);
		match.check("ETRS kick: dipole step  70", dip[70],   0.150513056237);
		match.check("ETRS kick: dipole step  80", dip[80],   0.040869378598);
		match.check("ETRS kick: dipole step  90", dip[90],  -0.042000666907);
		match.check("ETRS kick: dipole step 100", dip[100], -0.106673626874);		

		match.check("ETRS kick: energy step   0", en[0],   -17.563614906151);
		match.check("ETRS kick: energy step  10", en[10],  -17.563607649160);
		match.check("ETRS kick: energy step  20", en[20],  -17.563616264227);
		match.check("ETRS kick: energy step  30", en[30],  -17.563622641965);
		match.check("ETRS kick: energy step  40", en[40],  -17.563630174702);
		match.check("ETRS kick: energy step  50", en[50],  -17.563636241471);
		match.check("ETRS kick: energy step  60", en[60],  -17.563642463141);
		match.check("ETRS kick: energy step  70", en[70],  -17.563649395734);
		match.check("ETRS kick: energy step  80", en[80],  -17.563655115503);
		match.check("ETRS kick: energy step  90", en[90],  -17.563660623398);
		match.check("ETRS kick: energy step 100", en[100], -17.563665984612);	
	}
