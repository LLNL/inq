...
int main(int argc, char ** argv){
	...
	// Propagation without perturbation
	{
		...
		real_time::propagate<>(ions, electrons, output, input::interaction::lda(), options::real_time::num_steps(30) | options::real_time::dt(0.055_atomictime));
	...
	// Propagation without perturbation
	{
		...
		real_time::propagate<>(ions, electrons, output, input::interaction::lda(), options::real_time::num_steps(10) | options::real_time::dt(0.1_atomictime) | options::real_time::crank_nicolson());
	...
	
	{
		...
		real_time::propagate<>(ions, electrons, output, input::interaction::lda(), options::real_time::num_steps(nsteps) | options::real_time::dt(0.055_atomictime), ions::propagator::fixed{}, kick);
...

	{
		...
		real_time::propagate<>(ions, electrons, output, input::interaction::lda(), options::real_time::num_steps(nsteps) | options::real_time::dt(0.055_atomictime), ions::propagator::fixed{}, kick1 + kick2);
		...
		
	{
		...
		real_time::propagate<>(ions, electrons, output, input::interaction::lda(), options::real_time::num_steps(nsteps) | options::real_time::dt(0.055_atomictime) | options::real_time::crank_nicolson(), ions::propagator::fixed{}, kick);
